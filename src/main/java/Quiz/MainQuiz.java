...
public class MainQuiz extends Application {
    ...
    private static final String FILE_PATH = "user_credentials.txt"; // sebagai menyimpan informasi user
    private List<String> correctAnswerList = new ArrayList<>(); // Tambahkan baris ini
